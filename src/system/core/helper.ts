...
export class fsHelper {
  ...
  static locateFolderOf(filename: string, startpath?: string, searchUp?: boolean): string {
  ...
  static locateAndReadFile(filename: string, startpath?: string, searchUp?: boolean): Buffer {
    let libRoot = fsHelper.locateFolderOf(filename, startpath, searchUp); 
